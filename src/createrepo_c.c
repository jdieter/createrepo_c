...
main(int argc, char **argv)
{
    ...
    if(cmd_options->zck_primary_dict) {
        ...
        pri_dict = cr_read_from_file(&tmp_err, cmd_options->zck_primary_dict,
                                     &pri_dict_size);
        if (tmp_err) {
    ...
    if(cmd_options->zck_filelists_dict) {
        ...
        fil_dict = cr_read_from_file(&tmp_err, cmd_options->zck_filelists_dict,
                                     &fil_dict_size);
        if (tmp_err) {
    ...
    if(cmd_options->zck_other_dict) {
        ...
        oth_dict = cr_read_from_file(&tmp_err, cmd_options->zck_other_dict,
                                     &oth_dict_size);
        if (tmp_err) {
